...
public class KeyboardEvent {
  ...
  /**
   * Constructs a new {@link KeyboardEvent}.
   * 
   * @param key The key that the {@link KeyboardEvent} is about.
   * @param character The character that would be typed by this event, including
   * the effects of modifier keys.
   * @param nanoseconds The time that this event occurred.
   * @param state Whether the key was pressed or released.
   * @param repeat Whether this is a repeat event from the key being held.
   */
  ...
  public String toString() {
    return MessageFormat.format("[Key={0}, pressed={1}, repeat={2}]", 
      character,
      state,
      repeat);
  }
